    ...
    <div class="container">
        ...
        <div class="header-container">
            <div class="header-button-container">
                <a href="index.php" class="btn btn-primary header-button" target="_blank">
                    <i class="fas fa-sign-in-alt"></i> Login Allterus
                </a>
            </div>
        ...
        <script>
            const stationsByCategory = {
                ...
                //     name: 'Radio Maanaim',
                //     url: 'http://radiostream01.radiomaanaim.com.br:1935/liverm/rmaac/chunklist_w1919834617.m3u8'
                // }, {
