...
$stmtAguardando->execute([':user_id' => $id_n3rd]);
...
$stmtAReceber->execute([':user_id' => $id_n3rd]);
...
$stmt = $pdo->prepare("
    SELECT r.id, r.remarks, r.amount, r.cliente, r.date_created, u.firstname, u.lastname, c.categories
...
<body>
    ...
    <div class="container-fluid pt-3">
        <section class="d-flex justify-content-between align-items-center mb-3">
            <h1 class="h4 text-dark">Minhas Despesas</h1>
