...
<body>
    ...
    $projeto = filter_input(INPUT_POST, 'projeto', FILTER_SANITIZE_NUMBER_INT) ?? filter_input(INPUT_GET, 'projeto', FILTER_SANITIZE_NUMBER_INT) ?? null;

    $action = filter_input(INPUT_GET, 'acao', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
                                ...
                                <table class="table table-hover small">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="p-1">
                                                <form action="projeto2.php" method="POST"> <input type="hidden" name="projeto" value="<?= htmlspecialchars($projeto) ?>">
