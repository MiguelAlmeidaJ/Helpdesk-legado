...
if (isset($_POST['f_palavra']) && !empty(trim($_POST['f_palavra']))) {
  $f_palavra_raw = trim($_POST['f_palavra']);
  $f_palavra = '%' . $f_palavra_raw . '%';
  $filtro_palavra = "AND (LOWER(tarefas.nome_tarefa) LIKE LOWER('$f_palavra') 
...
//     $count_tarefas = $result_count_tarefas ? $result_count_tarefas['count_tarefas'] : 0;
// } catch (Exception $e) {
...
// // Consulta para contar as tarefas com os mesmos filtros
// $sql_count_tarefas = "SELECT COUNT(*) AS count_tarefas 
//                       FROM tarefas 
...
//                       AND tarefas.abertura BETWEEN '$data_1' AND '$data_2'
//                       AND tarefas.tecnico LIKE '$p_tec'
          ...
          <div class="card-header py-1">
            <form action="#" method="POST">
              <div class="form-row align-items-center">
                ...
                <div class="col-auto pt-3">
                  <a href="./hometarefas.php" class="btn btn-sm btn-outline-info" tabindex="4">
