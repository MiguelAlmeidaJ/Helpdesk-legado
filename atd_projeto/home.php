...
if ($ord == "id"){$order_by = "projetos.id ASC";}
if ($ord == "cliente"){$order_by = "clientes.clt_nomer ASC";}
if ($ord == "abertura"){$order_by = "projetos.abertura ASC";}
if ($ord == "tecnico"){$order_by = "tecnico_nome ASC";}
if ($ord == "status"){$order_by = "projetos.`status` ASC";}
if ($ord == "nivel"){$order_by = "projetos.`nivel` DESC";}
if ($ord == "forma"){$order_by = "projetos.`forma` DESC";}
...
<?php 
$pdo = ConnectionN3();
$show_projeto = $pdo->prepare("SELECT projetos.id,projetos.`nome_proj`, projetos.`area`, projetos.`tipo`, projetos.`local`, projetos.dias, projetos.forma, projetos.desc_abertura, projetos.desc_fechamento, projetos.abertura, projetos.fechamento, projetos.tecnico, projetos.reincidente, projetos.`status`,
...
<?php } ?>                    
                    ...
                    <td class="align-middle p-1">
                      <form action="projeto.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-light btn-sm p-1"><i class="far fa-folder-open"><?php echo $projeto ?></i></button>
                      </form>                    
                    </td>
                  </tr>
<?php } ?>
