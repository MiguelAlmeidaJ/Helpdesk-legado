              ...
              <div class="form-row align-items-center">
                ...
                <div class="col-auto col-form-label-sm">
                  ...
                  <select name="proj_nome" class="form-control form-control-sm selectpicker" data-live-search="true" required="required" tabindex="4">
                    ...
                    ?>
                      <option value="<?php echo $nome_proj; ?>" <?php if ($id == $nome_proj) {
                                                                  echo " selected";
                                                                } ?>><?php echo $nome_proj; ?></option>
                    <?php } ?>
                  </select>
                </div>
          ...
          <div class="card-body p-0">
            <table class="table table-hover small">
              ...
              <tbody>
                <?php
                $pdo = ConnectionN3();
                $show_tarefas = $pdo->prepare("SELECT tarefas.id, tarefas.`nome_tarefa`, tarefas.`dias`, tarefas.`area`, tarefas.`tipo`, tarefas.`local`, tarefas.forma, tarefas.desc_abertura, tarefas.desc_fechamento, tarefas.abertura, tarefas.fechamento, tarefas.tecnico, tarefas.reincidente, tarefas.nivel, tarefas.`status`,
