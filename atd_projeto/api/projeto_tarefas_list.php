...
include_once("../lib/projeto_detail_tasks.php");
...
try {
  ...
  $pdo = ConnectionN3();
  $result = atd_projeto_detail_fetch_tasks($pdo, $filters);

  echo json_encode([
    'ok' => true,
    'html' => [
      'rows' => atd_projeto_detail_render_task_rows($result['rows']),
      'loader' => atd_projeto_detail_render_loader($result['pagination']),
    ],
