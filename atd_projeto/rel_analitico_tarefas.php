...
<body>
  ...
  <div class="container-fluid">
                        ...
                        <div class="form-row align-items-center">
                          ...
                          <div class="col-auto col-form-label-sm">
                            ...
                            <select name="f_tec" class="form-control form-control-sm mb-2 mt-n2 selectpicker" data-live-search="true" required="required" tabindex="1">
                              ...
                              <?php
                              $sql = "SELECT user_id, user_nome FROM usuarios WHERE user_funcao BETWEEN 8 AND 14 ORDER BY user_nome ASC";
    ...
    <div class="row mt-2 mb-2">
      <div class="col-md-12">
        <div class="card bg-default">
          ...
          $query = "SELECT count(tarefas.id) as n FROM tarefas WHERE tarefas.cliente = IF(:f_clt = 0, tarefas.cliente, :f_clt) AND tarefas.tecnico LIKE :f_tec AND tarefas.abertura BETWEEN :data_1 AND :data_2" . $filterEmpresas;
    ...
    itens.itens_nome,
    usuarios.user_nome,
    tarefas.id, tarefas.tipo, tarefas.forma, tarefas.nivel, tarefas.desc_abertura, tarefas.desc_fechamento, tarefas.abertura, tarefas.fechamento, tarefas.`status`,
    TIMESTAMPDIFF(HOUR, tarefas.abertura, tarefas.fechamento) as sla_horas
    FROM tarefas
    ...
    AND tarefas.cliente = IF(:f_clt = 0, tarefas.cliente, :f_clt)
    AND tarefas.tecnico LIKE :f_tec
