...
<head>
  ...
  <style>
    .table thead th {
      vertical-align: top;
      max-width: 200px;/* Defina a largura máxima da célula */
      white-space: nowrap;/* Evita quebra de linha nos cabeçalhos */
      word-wrap: break-word;/* Compatibilidade com navegadores mais antigos */
      text-align: center;/* Alinha o texto ao centro em todas as células da tabela */
    }
    ...
    .dropdown-menu .dropdown-visualizar {
      max-height: 600px !important;  /* Define a altura maxima da caixa do menu suspenso */
      overflow-y: auto; /* Adiciona barra de rolagem vertical */
      position: absolute; /* Garante posicionamento baseado no botão */
      margin-left: 0 !important;  /* Alinha a borda esquerda do menu com o botão */
      margin-right: 0 !important;  /* Alinha a borda esquerda do menu com o botão */
      width: 100%; /* Faz com que o menu tenha a mesma largura do botão */
      font-size: 10px;
    }
    ...
    .dropdown-toggle-coluna {
      position: relative; /* Define o botão como referência para posicionar o menu */
      width: 180px;/* Ajusta a largura do botão controle de colunas para coincidir com o tamamnho do menu suspenso */
    }
