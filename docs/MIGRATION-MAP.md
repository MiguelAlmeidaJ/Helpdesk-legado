...
| catalog | `catlg` | `nivel3` | cutover | Native NestJS read/write paths, Next.js catalog management and ticket-context resolution are active with TI/DevOps permission scoping. `catlg/` remains only for the strict retirement audit and final removal. See `docs/CATALOG-MIGRATION.md`. |
