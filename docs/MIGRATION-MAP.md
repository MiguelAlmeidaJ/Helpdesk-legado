...
| catalog | `catlg` | `nivel3` | api-write | Native NestJS paths now cover read, create and edit with TI/DevOps permission scoping. The legacy module has no delete flow; PHP remains only until the Next.js UI/cutover is complete. See `docs/CATALOG-MIGRATION.md`. |
