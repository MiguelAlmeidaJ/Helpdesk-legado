...
| assets | retired `ativos/` | `plugins_app`, `patrimonios` | decommissioned | Legacy runtime removed after the external-reference audit. Database data remains preserved and no 1:1 Nest/Next migration is planned. See `docs/ASSETS-DECOMMISSION.md`. |
