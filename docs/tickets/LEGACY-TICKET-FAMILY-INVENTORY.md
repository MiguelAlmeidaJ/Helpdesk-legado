...
Fingerprint do inventario: `c31e133eeb2cdee28025a0bf55bc6fa78298111cb95a8e7790a7b2ac3e0bccb9`.
...
| DEAD | 39 |
| UNKNOWN | 0 |
| classificacoes com override manual | 51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `atd_3andar/api/projeto_tarefas_list.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/api/tarefas_list.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/busca_locais.php` | yes | - | no | no | no | - | - | - | atd_3andar/js/tarefa-create.js, atd_mkt/projeto.php, atd_mkt/tarefa.php, melhorias/atd.php, rel/rel_Unificado.php, rel/rel_Unificado_Id.php, rel/rel_ti.php | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/busca_solicitantes.php` | yes | - | no | no | no | - | - | - | atd_3andar/js/tarefa-create.js, atd_mkt/projeto.php, atd_mkt/tarefa.php, melhorias/atd.php | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
...
| `atd_3andar/lib/detail_tasks.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/lib/list_helpers.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/lib/permission_fallback.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/lib/tarefa_actions.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/lib/tarefa_controller.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/lib/tarefa_helpers.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/lib/tarefa_permissions.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/lib/tarefa_queries.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/lib/tarefa_ui_rules.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
...
| `atd_3andar/views/detail/tarefa_acoes.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/views/detail/tarefa_sidebar_cliente.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/views/detail/tarefa_timeline.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/views/partials/alerts.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/views/partials/head.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/views/partials/quick_modal.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/views/partials/scripts.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/views/tarefa_create.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/views/tarefa_detail.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_3andar/views/tarefa_modals.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/marketing / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
...
| `atd_projeto/add_image_tarefa.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/devops / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_projeto/api/projeto_tarefas_list.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/devops / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_projeto/api/projetos_list.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/devops / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_projeto/api/tarefas_list.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/devops / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_projeto/busca_itens.php` | yes | - | no | no | no | - | - | - | atd_mkt/projeto.php, atd_mkt/tarefa.php, melhorias/atd.php | DEAD / tickets/devops / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_projeto/busca_locais.php` | yes | - | no | no | no | - | - | - | atd_3andar/js/tarefa-create.js, atd_mkt/projeto.php, atd_mkt/tarefa.php, melhorias/atd.php, rel/rel_Unificado.php, rel/rel_Unificado_Id.php, rel/rel_ti.php | DEAD / tickets/devops / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_projeto/busca_solicitantes.php` | yes | - | no | no | no | - | - | - | atd_3andar/js/tarefa-create.js, atd_mkt/projeto.php, atd_mkt/tarefa.php, melhorias/atd.php | DEAD / tickets/devops / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_projeto/busca_subcategorias.php` | yes | - | no | no | no | - | - | - | atd_mkt/projeto.php, atd_mkt/tarefa.php, melhorias/atd.php | DEAD / tickets/devops / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
...
| `atd_projeto/delete_image_tarefa.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/devops / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_projeto/edit_image_tarefa.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/devops / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
...
| `atd_projeto/lib/list_helpers.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/devops / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
| `atd_projeto/lib/projeto_detail_tasks.php` | yes | - | no | no | no | - | - | - | - | DEAD / tickets/devops / entrypoints PHP redirecionados e nenhum caller qualificado restante | override: HTTP 410; comportamento correspondente pertence ao Next/Nest | `a0b400b3bd24` |
