...
$colunas_validas = ['id', 'name', 'nome_cliente', 'priority', 'total_artes', 'nome_tecnico', 'nome_direcionador', 'status', 'inicio', 'prazo', 'finalizado'];
                        ...
                        <form action="#" method="POST" id="filtrosForm">
                            <div class="form-row align-items-center">
                                <div class="col-1 col-form-label-sm">
                                    ...
                                    <input type="text" name="id" class="form-control form-control-sm my-1" value="<?= htmlspecialchars($_POST['id'] ?? '') ?>">
                                </div>
                                ...
                                <div class="col-1 col-form-label-sm">
                                    ...
                                    <select class="form-control form-control-sm" name="prioridade" id="prioridade">
                                        ...
                                        foreach ($prioridades as $key => $value) {
                                            echo "<option value='$key' " . ((isset($_POST['prioridade']) && $_POST['prioridade'] == $key) ? 'selected' : '') . ">$value</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <button type="submit" name="filtrar" class="btn btn-sm btn-info my-1 mr-2 mt-4">Filtrar</button>
