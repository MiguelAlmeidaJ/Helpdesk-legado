  ...
  if ($usar_token == "true") {
    if ($action) {
      if ($action == "projeto_adc") {
        $nome_proj = filter_input(INPUT_POST, 'nome_proj', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      ...
      WHERE proj_mkt.id = '$projs_mkt'");
        ...
        if ($dias != $projeto_dias_original) {
          //ALTERA O CÓDIGO DO NºVEL NA TABELA DE proj_mkt
          $pdo = ConnectionN3();
        ...
        <div class="col-12 col-sm-12 col-md-11 col-lg-10">
          <div class="card">
            <div class="h6 card-header">
              <i class="fas fa-headset text-danger"></i> Cadastro de solicitantes
            </div>
    ...
    if ($usar_token == "true") {
      if ($action) {
        if ($action == "new_tarefa") {
          ...
          $dias = filter_input(INPUT_POST, 'dias', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
          if ($dias == 0) {
            $tarefas_dias_n = "Não informado";
          }
          if ($dias == 1) {
            $atd_dias_nome = "sla_n1";
          }
          if ($dias == 2) {
            $atd_dias_nome = "sla_n2";
          }
          if ($dias == 3) {
            $atd_dias_nome = "sla_n3";
          }
          if ($dias == 4) {
            $atd_dias_nome = "sla_n4";
          }
          if ($dias == 5) {
            $atd_dias_nome = "sla_n5";
          }
          if ($dias == 6) {
            $atd_dias_nome = "sla_n6";
          }
          if ($dias == 7) {
            $atd_dias_nome = "sla_n7";
          }
          if ($dias == 8) {
            $atd_dias_nome = "sla_n8";
          }
          if ($dias == 9) {
            $atd_dias_nome = "sla_n9";
          }
          if ($dias == 10) {
            $atd_dias_nome = "sla_n10";
          }
          if ($dias == 11) {
            $atd_dias_nome = "sla_n11";
          }
          if ($dias == 12) {
            $atd_dias_nome = "sla_n12";
          }
          if ($dias == 13) {
            $atd_dias_nome = "sla_n13";
          }
          if ($dias == 14) {
            $atd_dias_nome = "sla_n14";
          }
      ...
      <div class="row mt-2">
        ...
        <div class="col-md-6 px-1">
          <div class="card">
            ...
            if ($ord == "id") {
              $order_by = "tarefas_mkt.id ASC";
            }
            if ($ord == "cliente") {
              $order_by = "clientes.clt_nomer ASC";
            }
            if ($ord == "abertura") {
              $order_by = "tarefas_mkt.abertura ASC";
            }
            if ($ord == "tecnico") {
              $order_by = "tecnico_nome ASC";
            }
            if ($ord == "status") {
              $order_by = "tarefas_mkt.`status` ASC";
            }
            if ($ord == "dias") {
              $order_by = "tarefas_mkt.`dias` DESC";
            }
            if ($ord == "forma") {
              $order_by = "tarefas_mkt.`forma` DESC";
            }
...
");
                  ...
                  <div class="card mt-3">
                    ...
                    if (isset($ged_fd_id)) {
                      $ged_open_folder = $ged_fd_id;
                    }
                    //SE HOUVER, ABRE O CARD DA GESTÃO DE DOCUMENTOS
                    if (isset($ged_open_folder)) {
                      $show_card_ged = true;
                    } else {
                      $show_card_ged = false;
                    }
                    ?>
                    <div class="collapse <?php if ($show_card_ged == true) {
                                            echo " show";
                                          } ?>" id="gdoc">
                      <div class="card-body p-0">
                                ...
                                <div class="row p-1">
                                  ...
                                  <div class="col-sm-4 ml-auto">
                                    ...
                                    <div class="row py-1">
                                      ...
                                      if ($ged_exibir == "ativos") {
                                        $ged_fl_sts = "2";
                                      }
                                      if ($ged_exibir == "arquivados") {
                                        $ged_fl_sts = "1";
                                      }
                                      if ($ged_exibir == "excluidos") {
                                        $ged_fl_sts = "0";
                                      }
                                      if ($ged_exibir == "todos") {
                                        $ged_fl_sts = "0,1,2";
                                      ...
                                      if (empty($ged_ordenar)) {
                                        $ged_ordenar = "name_asc";
                                      }
                                      if ($ged_ordenar == "name_asc") {
                                        $ged_order_by = "ged_fl_name ASC";
                                      }
                                      if ($ged_ordenar == "name_desc") {
                                        $ged_order_by = "ged_fl_name DESC";
                                      }
                                      if ($ged_ordenar == "data_asc") {
                                        $ged_order_by = "ged_fl_dt ASC, ged_fl_name ASC";
                                      }
                                      if ($ged_ordenar == "data_desc") {
                                        $ged_order_by = "ged_fl_dt DESC, ged_fl_name DESC";
                                      }
                                      if ($ged_ordenar == "user_asc") {
                                        $ged_order_by = "user_nome ASC, ged_fl_dt ASC, ged_fl_name ASC";
                                      }
                                      if ($ged_ordenar == "user_desc") {
                                        $ged_order_by = "user_nome DESC, ged_fl_dt DESC, ged_fl_name DESC";
                                      }
                                    ...
                                    ?>
                                        <tr>
                                          <td class="type align-middle py-0">
                                            <?php
                                            if ($ged_fl_ext == "doc" || $ged_fl_ext == "txt" || $ged_fl_ext == "docx") { ?> <i class="fa fa-file-word text-info"></i> <?php } elseif ($ged_fl_ext == "xls" || $ged_fl_ext == "csv" || $ged_fl_ext == "xlsx") { ?> <i class="fa fa-file-excel text-success"></i> <?php } elseif ($ged_fl_ext == "ppt" || $ged_fl_ext == "pps" || $ged_fl_ext == "pptx") { ?> <i class="fa fa-file-powerpoint text-warning"></i> <?php } elseif ($ged_fl_ext == "xml" || $ged_fl_ext == "htm" || $ged_fl_ext == "html") { ?> <i class="fa fa-file-code text-primary"></i> <?php } elseif ($ged_fl_ext == "jpg" || $ged_fl_ext == "png" || $ged_fl_ext == "jpeg") { ?> <i class="fa fa-file-image text-primary"></i> <?php } elseif ($ged_fl_ext == "pdf") { ?> <i class="fa fa-file-pdf text-warning"></i> <?php } else { ?> <i class="fa fa-file text-dark"></i> <?php }
                                              ?>
                                          </td>
                  ...
                  <select name="ged_fl_folder" class="form-control form-control-sm" required="required" tabindex="9">
                    ...
                    if ($conta_folder > 0) {
                      while ($exibe = $show_folder->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        $ged_fd_folder = $exibe["ged_fd_folder"];
                    ?>
                        <option value="<?php echo $ged_fd_id; ?>" <?php if ($ged_open_folder == $ged_fd_id) {
                                                                    echo " selected";
                                                                  } ?>><?php echo $ged_fd_folder; ?></option>
                      <?php } ?>
                    <?php } ?>
                  </select>
                </div>
                    ...
                    <div class="form-row pt-2">
                      ...
                      <div class="form-group col-sm-6 col-md-2">
                        ...
                        <select name="dias" class="form-control form-control-sm" required="required" tabindex="8">
                          ...
                          <option value="14">Reuniao</option>
