...
export const DEFAULT_NAVIGATION: SeedSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'report-client-daily', label: 'Atd. diário por Cliente', href: '/relatorios/atendimentos/diario-por-cliente', status: 'available', visibilityCondition: { anyPermissions: ['tickets.read'] } },
      { slug: 'report-requester', label: 'Atd. por Solicitante', href: '/relatorios/atendimentos/por-solicitante', status: 'available', visibilityCondition: { anyPermissions: ['tickets.read'] } },
      ...
      { slug: 'report-tech-daily', label: 'Atd. diário por Técnico', href: '/relatorios/atendimentos/diario-por-tecnico', status: 'available', visibilityCondition: { anyPermissions: ['tickets.read'] } },
