...
if (isset($_POST["user_id"])) {
  ...
  $user_m9_02 = $user_mod_09[2]; //CONTAS A PAGAR / RECEBER
  $user_m9_03 = $user_mod_09[3]; // GESTAO E PAGAMENTO
      ...
      <div id="collapse1" class="collapse show" aria-labelledby="heading1" data-parent="#accordionExample">
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 ">
              <span class="form-text text-muted">Link:</span>
              <div class="input-group">
                <div class="input-group-prepend">
                  <div class="input-group-text">
                    <i class="fas fa-mobile-alt"></i>
                ...
                <input name="link" value="<?php echo $link; ?>" type="text" class="form-control">
              </div>
            </div>
            ...
            <!-- <div class="col-12 col-sm-6 col-md-4 col-lg-3 ">
              ...
              <div class="input-group" >
                ...
                <input type="radio" id="nivel3" name="tipo_usuario" value="1" <?php if ($tipo == 1) {
                                                                                echo " checked";
                                                                              } ?>>
                ...
                <?php if (isset($_SESSION['tipo']) && $_SESSION['tipo'] == 2 || $_SESSION['tipo'] == 1) { ?>
                  <input type="radio" id="cliente" name="tipo_usuario" value="2" <?php if ($tipo == 2) {
                                                                                    echo " checked";
                                                                                  } ?>>
