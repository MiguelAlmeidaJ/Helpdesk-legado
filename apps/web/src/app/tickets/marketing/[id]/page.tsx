...
export const metadata: Metadata = { title: 'Atendimento de Marketing · Helpdesk' };
...
export default async function MarketingTicketDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const currentUser = await requireAuthenticatedUser(`/atendimentos/marketing/${ticketId}`);
