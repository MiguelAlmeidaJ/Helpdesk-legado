              ...
              <ul class="list-unstyled">
                ...
                <script>
                  document.addEventListener("DOMContentLoaded", function() {
                    ...
                    // Função para criar campos ocultos dinamicamente
                    ...
                    document.querySelectorAll(".catalog-item").forEach(item => {
                      item.addEventListener("click", function(e) {
                        ...
                        form.appendChild(createHiddenInput("clt_id", clt_id));
                        form.appendChild(createHiddenInput("categoria_id", categoria_id));
                        form.appendChild(createHiddenInput("cargo", cargo));
                        form.appendChild(createHiddenInput("user_id", user_id));

                        // Adicionando formulário ao corpo e enviando
