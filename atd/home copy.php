        ...
        <tbody>
          ...
          ?>
            ...
            <tr>
              ...
              <td class="align-middle">
                <?php //se atendimento aberto (status 1, 2 e 3)com mais de 40 minutos e menos de 60 min,sem interação, mostra sino piscando vermelho

                //ALTERADA A LINHA ABAIXO PARA A INTERAÇÃO NAO INFLUENCIAR NO SINO DO SLA
                //if ($subcategoria == ) if ($$atd_status >= 1 && $atd_status < 3 && $time_last_inter >= 40 && $time_last_inter < 60) 


                if ($atd_status >= 1 && $atd_status < 3 && $time_last_inter_inicio >= 40 && $time_last_inter_inicio < 60) { ?>
                  <i class="fas fa-bell fa-2x blinkkk"></i>
                <?php } ?>

                <?php //se atendimento aberto (status 1,2 e 3) com mais de 60 minutos sem interação, mostra sino piscando preto
                if ($atd_status >= 1 && $atd_status < 3 && $time_last_inter_inicio >= 60) { ?>
                  <i class="fas fa-bell fa-2x blinkk"></i>
                <?php } ?>
