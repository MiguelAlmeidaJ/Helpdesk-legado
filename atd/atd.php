...
//=====================================================================email=============================================================================================================================================================
          ...
          $body = "<strong>CHAMADO ABERTO</strong><br> pela empresa: <strong>" . $clienteNome . "</strong> <strong>//</strong> solicitado por: <strong>" . $pessoaNome . "</strong><br>Conteúdo do chamado: <strong>" . $desc_abertura . "</strong><br>Sendo executado pelo técnico: <strong>" . $tecnicoNome. "</strong>";
        ...
        if ($edt->execute()) {
          ...
          if ($adc->execute()) {
            ...
            if ($adc->execute()) {
              ...
              $body = "<strong>CHAMADO CONCLUIDO!</strong> <br>Chamado da empresa: <strong>". $clienteNome ." </strong><strong>//</strong> Solicitado por: <strong>". $pessoaNome ."</strong><br>Descrição da conclusão do chamado: <strong>" . $concluido_desc . "</strong><br>Foi executado pelo técnico: <strong>" . $tecnicoNome."</strong>";
