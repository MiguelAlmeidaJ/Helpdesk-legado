        ...
        <div class="card">
                ...
                <?php if (isset($_SESSION['tipo']) && $_SESSION['tipo'] != 2) { ?>
                  ...
                  <div class="col-auto col-form-label-sm">
                    ...
                    <div class="dropdown" style="width: 160px;">
                      ...
                      <div class="dropdown-menu" style="padding: 10px; width: 200px; border-radius: 4px; max-height: 300px; overflow-y: auto;">
          ...
          <script>
            function updateItems() {
              ...
              var url = 'home1.php?action=getItems&f_id=' + encodeURIComponent(selectedId);
