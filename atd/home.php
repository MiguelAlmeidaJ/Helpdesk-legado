...
// Filtros por data
if (!empty($f_date_1) && !empty($f_date_2)) {
  $baseSql .= " AND atendimentos.abertura BETWEEN '$f_date_1 00:00:00' AND '$f_date_2 23:59:59'";
} elseif (!empty($f_date_1)) {
  $baseSql .= " AND atendimentos.abertura >= '$f_date_1 00:00:00'";
} elseif (!empty($f_date_2)) {
  $baseSql .= " AND atendimentos.abertura <= '$f_date_2 23:59:59'";
}
      ...
      <table class="table table-hover small">
        ...
        <tbody>
          ...
          if (!empty($f_tipo)) {
            ...
            $tiposSelecionados = "AND atendimentos.tipo IN (0,1,2,3,4,5,6)"; // nenhum filtro = traz todos
            // melhoria é o tipo 6 . se nao for para mostrar melhoria basta remover o tipo 6
          }
