...
if ($ord == "id") {
  $order_by = "atendimentos.id ASC";
}
if ($ord == "cliente") {
  $order_by = "clientes.clt_nomer ASC";
}
if ($ord == "abertura") {
  $order_by = "atendimentos.abertura ASC";
}
if ($ord == "tecnico") {
...
$pdo = ConnectionN3();
$show_atd = $pdo->prepare("SELECT atendimentos.id FROM atendimentos 
...
$total_atendimentos = $show_atd->rowCount(); // Conta o número de atendimentos
            ...
            <form action="#" method="POST">
              <div class="form-row align-items-center">
                ...
                <div class="col-auto col-form-label-sm">
                  ...
                  <input id="data_1" name="data_1" class="form-control form-control-sm" type="date" value="<?php echo $data_1; ?>" class="form-control mb-2 mt-n2 form-control-sm">
                </div>
                <div class="col-auto col-form-label-sm">
                  <label class="my-0">Até:</label>
                  <input id="data_2" name="data_2" class="form-control form-control-sm" type="date" value="<?php echo $data_2; ?>" class="form-control mb-2 mt-n2 form-control-sm">
                </div>
                ...
                <div class="col-auto pt-3">
                  ...
                  <div class="row">
                  <div class="col-auto pt-3">
                  <h4 class="btn btn-sm btn-outline-info" tabindex="5">Total de Atendimentos: <?php echo $total_atendimentos; ?></h4>
                  </div> 
              </div>
            </form>
          </div>
