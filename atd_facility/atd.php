    ...
    if ($action) {
      ...
      WHERE facility.id = '$atd'");
        ...
        if ($nivel != $atd_nivel_original) {
          //ALTERA O CÓDIGO DO NºVEL NA TABELA DE facility
          $pdo = ConnectionN3();
            ...
            <div class="card-body pt-1 pl-0 pr-0">
              <ul class="list-unstyled">
                ...
                <li class="pl-2 mt-1 d-flex align-items-center">
                  ...
                  <?php if ($atd_forma == 4) { ?> <i class="fas fa-briefcase mr-2 text-danger"></i> Atendimento Presencial - Plantão <?php } ?>
          ...
          <div class="modal-content">
            <form action="#" method="POST">
              ...
              <div class="modal-body">
                ...
                <label class="small">Se o técnico informado NºO for o próprio usuário: a) este atendimento será redirecionado para a fila de facility do técnico informado; b) este atendimento contuará com o status "Aguardando atendimento" até que o técnico responsóvel confirme o início da execução.</label>
            ...
            <form action="#" method="POST">
              ...
              <div class="modal-body">
                <div class="form-row">
                  ...
                  <label class="small">Ao confirmar esta tela informando um técnico responsóvel: a) este atendimento será redirecionado para a fila de facility do técnico informado; b) este atendimento contuará com o status "Aguardando atendimento" até que o técnico responsóvel confirme o início da execução.</label>
                  <label class="small pt-1">Não esqueça de informar todas as interação com o cliente.</label>
                </div>
                <div class="form-row">
                  <div class="form-group col-sm-12">
