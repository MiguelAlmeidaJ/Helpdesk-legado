...
if ($usar_token == "true") {
  if ($action) {
    ...
    if ($action == "new_cat") {
      $cat_nome = filter_input(INPUT_POST, 'cat_nome', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $cat_setor = filter_input(INPUT_POST, 'cat_setor', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if ($action == "new_scat") {
      $scat_nome = filter_input(INPUT_POST, 'scat_nome', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if ($action == "new_item") {
      $itens_nome = filter_input(INPUT_POST, 'itens_nome', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
