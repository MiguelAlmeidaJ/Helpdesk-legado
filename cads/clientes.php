...
if ($usar_token == "true") {
  if ($action) {
    ...
    if ($action == "new_clt") {
      $clt_nomer = filter_input(INPUT_POST, 'clt_nomer', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $clt_nomef = filter_input(INPUT_POST, 'clt_nomef', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $clt_cnpj = filter_input(INPUT_POST, 'clt_cnpj', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $clt_end = filter_input(INPUT_POST, 'clt_end', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $clt_city = filter_input(INPUT_POST, 'clt_city', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $clt_uf = filter_input(INPUT_POST, 'clt_uf', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $clt_mail = filter_input(INPUT_POST, 'clt_mail', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $clt_tel = filter_input(INPUT_POST, 'clt_tel', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if ($action == "edt_clt") {
      ...
      $clt_mail = filter_input(INPUT_POST, 'clt_mail', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $clt_tel = filter_input(INPUT_POST, 'clt_tel', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $clt_ti = filter_input(INPUT_POST, 'clt_ti', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $clt_adm = filter_input(INPUT_POST, 'clt_adm', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $clt_mkt = filter_input(INPUT_POST, 'clt_mkt', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $clt_sts = filter_input(INPUT_POST, 'clt_sts', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if ($action == "new_pessoa") {
      $pessoa_nom = filter_input(INPUT_POST, 'pessoa_nom', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $pessoa_cargo = filter_input(INPUT_POST, 'pessoa_cargo', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $pessoa_tel = filter_input(INPUT_POST, 'pessoa_tel', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $pessoa_mail = filter_input(INPUT_POST, 'pessoa_mail', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if ($action == "new_local") {
      ...
      $local_nom = filter_input(INPUT_POST, 'local_nom', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $local_end = filter_input(INPUT_POST, 'local_end', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $local_city = filter_input(INPUT_POST, 'local_city', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $local_uf = filter_input(INPUT_POST, 'local_uf', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if ($action == "edt_local") {
      ...
      $local_city = filter_input(INPUT_POST, 'local_city', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $local_uf = filter_input(INPUT_POST, 'local_uf', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
      $local_sts = filter_input(INPUT_POST, 'local_sts', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <?php if ($clt_adm == 1) { ?><i class="fas fa-chart-bar text-primary px-1" title="DEVOPS"></i><?php } ?>
                      ...
                      <td class="d-flex gap-2" style="margin-right: 10px;">
                        <button type="button" class="btn btn-outline-secondary btn-sm view_clt" style="margin-right: 10px;" id="<?php echo $row['clt_id']; ?>"> <i class="far fa-edit"></i> </button>
                        <button type="button" class="btn btn-outline-secondary btn-sm view_contato" style="margin-right: 10px;" id="<?php echo $row['clt_id']; ?>"> <i class="fas fa-user-tag"></i> </button>
