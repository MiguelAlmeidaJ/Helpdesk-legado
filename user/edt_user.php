          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m1_00" required="required" class="custom-select">
                <option value="0"<?php if($user_m1_00 == 0){echo " selected";}?>>Desabilitado</option>
                <option value="1"<?php if($user_m1_00 == 1){echo " selected";}?>>Habilitado</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m1_01" required="required" class="custom-select">
                <option value="0"<?php if($user_m1_01 == 0){echo " selected";}?>>Desabilitado</option>
                <option value="1"<?php if($user_m1_01 == 1){echo " selected";}?>>Habilitado</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m1_02" required="required" class="custom-select">
                <option value="0"<?php if($user_m1_02 == 0){echo " selected";}?>>Desabilitado</option>
                <option value="1"<?php if($user_m1_02 == 1){echo " selected";}?>>Habilitado</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m1_03" required="required" class="custom-select">
                <option value="0"<?php if($user_m1_03 == 0){echo " selected";}?>>Desabilitado </option>
                <option value="1"<?php if($user_m1_03 == 1){echo " selected";}?>>Habilitado</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m1_04" required="required" class="custom-select">
                <option value="0"<?php if($user_m1_04 == 0){echo " selected";}?>>Desabilitado </option>
                <option value="1"<?php if($user_m1_04 == 1){echo " selected";}?>>Habilitado</option>
              </select>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m2_00" required="required" class="custom-select">
                <option value="0"<?php if($user_m2_00 == 0){echo " selected";}?>>Desabilitado</option>
                <option value="1"<?php if($user_m2_00 == 1){echo " selected";}?>>Habilitado</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m2_01" required="required" class="custom-select">
                <option value="0"<?php if($user_m2_01 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="1"<?php if($user_m2_01 == 1){echo " selected";}?>>Apenas visualizar</option>
                <option value="2"<?php if($user_m2_01 == 2){echo " selected";}?>>Cadastrar</option>
                <option value="3"<?php if($user_m2_01 == 3){echo " selected";}?>>Cadastrar + Editar</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m2_02" required="required" class="custom-select">
                <option value="0"<?php if($user_m2_02 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="1"<?php if($user_m2_02 == 1){echo " selected";}?>>Apenas visualizar</option>
                <option value="2"<?php if($user_m2_02 == 2){echo " selected";}?>>Cadastrar</option>
                <option value="3"<?php if($user_m2_02 == 3){echo " selected";}?>>Cadastrar + Editar</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m2_03" required="required" class="custom-select">
                <option value="0"<?php if($user_m2_03 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="1"<?php if($user_m2_03 == 1){echo " selected";}?>>Apenas visualizar</option>
                <option value="2"<?php if($user_m2_03 == 2){echo " selected";}?>>Cadastrar</option>
                <option value="3"<?php if($user_m2_03 == 3){echo " selected";}?>>Cadastrar + Editar</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m2_04" required="required" class="custom-select">
                <option value="0"<?php if($user_m2_04 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="1"<?php if($user_m2_04 == 1){echo " selected";}?>>Apenas visualizar</option>
                <option value="2"<?php if($user_m2_04 == 2){echo " selected";}?>>Cadastrar</option>
                <option value="3"<?php if($user_m2_04 == 3){echo " selected";}?>>Cadastrar + Editar</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m2_05" required="required" class="custom-select">
                <option value="0"<?php if($user_m2_05 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="1"<?php if($user_m2_05 == 1){echo " selected";}?>>Apenas visualizar</option>
                <option value="2"<?php if($user_m2_05 == 2){echo " selected";}?>>Cadastrar</option>
                <option value="3"<?php if($user_m2_05 == 3){echo " selected";}?>>Cadastrar + Editar</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m2_06" required="required" class="custom-select">
                <option value="0"<?php if($user_m2_06 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="1"<?php if($user_m2_06 == 1){echo " selected";}?>>Apenas visualizar</option>
                <option value="2"<?php if($user_m2_06 == 2){echo " selected";}?>>Cadastrar</option>
                <option value="3"<?php if($user_m2_06 == 3){echo " selected";}?>>Cadastrar + Editar</option>
              </select>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m3_00" required="required" class="custom-select">
                <option value="0"<?php if($user_m3_00 == 0){echo " selected";}?>>Desabilitado</option>
                <option value="1"<?php if($user_m3_00 == 1){echo " selected";}?>>Habilitado</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m3_01" required="required" class="custom-select">
                <option value="0"<?php if($user_m3_01 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="2"<?php if($user_m3_01 == 2){echo " selected";}?>>Cadastrar</option>
                <option value="3"<?php if($user_m3_01 == 3){echo " selected";}?>>Cadastrar + Editar</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m3_02" required="required" class="custom-select">
                <option value="0"<?php if($user_m3_02 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="2"<?php if($user_m3_02 == 2){echo " selected";}?>>Aceitar + Finalizar</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m3_03" required="required" class="custom-select">
                <option value="0"<?php if($user_m3_03 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="2"<?php if($user_m3_03 == 2){echo " selected";}?>>Permitido</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m3_04" required="required" class="custom-select">
                <option value="0"<?php if($user_m3_04 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="2"<?php if($user_m3_04 == 2){echo " selected";}?>>Permitido</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m3_05" required="required" class="custom-select">
                <option value="0"<?php if($user_m3_05 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="2"<?php if($user_m3_05 == 2){echo " selected";}?>>Permitido</option>
              </select>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m4_00" required="required" class="custom-select">
                <option value="0"<?php if($user_m4_00 == 0){echo " selected";}?>>Desabilitado</option>
                <option value="1"<?php if($user_m4_00 == 1){echo " selected";}?>>Habilitado</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m4_01" required="required" class="custom-select">
                <option value="0"<?php if($user_m4_01 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="3"<?php if($user_m4_01 == 3){echo " selected";}?>>Editar</option>
              </select>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="input-group">
              ...
              <select name="m4_02" required="required" class="custom-select">
                <option value="0"<?php if($user_m4_02 == 0){echo " selected";}?>>Sem Acesso</option>
                <option value="3"<?php if($user_m4_02 == 3){echo " selected";}?>>Editar</option>
              </select>
            </div>
          </div>
