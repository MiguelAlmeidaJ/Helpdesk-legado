...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_POST['action'])  && $_POST['action'] == "new_user") {
    ...
    $adc_user->bindParam(':pix_type', $pix_type, PDO::PARAM_STR);
...
<body>
      ...
      <div class="col-md-12 mt-2">
        <div class="card">
          <div class="card-header py-2">
            <div class="row">
              <div class="col-6 h6 pt-1">
                <i class="fas fa-users"></i> Usuários cadastrados
              </div>
              <div class="col-6 text-right">
                <!-- ? Mantém sintaxe Bootstrap 4 -->
                <button type="button" class="btn btn-outline-primary btn-sm text-center text-dark" data-toggle="modal" data-target="#new_user">
                  <i class="fas fa-user-plus text-dark"></i> Adicionar Usuário
                </button>
              </div>
            </div>
          </div>
              ...
              <table class="table table-hover table-striped table-sm">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      <td>
                        <?php if ($row["user_sts"] == 1) { ?><i class="fas fa-toggle-on text-primary" title="Ativo"></i><?php } ?>
                        <?php if ($row["user_sts"] == 2) { ?><i class="fas fa-toggle-off text-muted" title="Inativo"></i><?php } ?>
                      </td>
                      <td><?php echo $row["user_nome"]; ?></td>
                      <td><?php echo $row["cargo_nome"]; ?></td>
                      <td><?php echo $row["tipo_usuario"] == 1 ? "Colaborador" : "Cliente"; ?></td>
                      <td>
                        <button type="button" class="btn btn-outline-secondary btn-sm view_data" id="<?php echo $row['user_id']; ?>">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-12">
                ...
                <div class="input-group">
                  ...
                  <input name="user_nome" placeholder="Nome Completo" type="text" class="form-control form-control-sm" required="required">
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input name="user_mail" type="email" class="form-control form-control-sm" required="required">
                </div>
              </div>
              ...
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input name="user_cel" placeholder="(00)00000-0000" type="text" required="required" class="form-control form-control-sm">
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input name="user_login" type="text" required="required" class="form-control form-control-sm">
                </div>
              </div>
              ...
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input name="user_pass" type="password" required="required" class="form-control form-control-sm" id="passwordInput">
                </div>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input name="chavepix" placeholder="Chave Pix" type="text" class="form-control form-control-sm">
                </div>
              </div>
            </div>
              ...
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  <div style="padding-top: 5px">
                    ...
                    <label class="small mb-1" for="admin" class="mr-3">Colaborador</label>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input name="link" placeholder="Coloque o link" type="text" class="form-control form-control-sm">
                </div>
              </div>
            </div>
  ...
  <div class="modal fade" id="modalEdtUser" tabindex="-1" role="dialog" aria-labelledby="edt_user" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <form method="POST" action="" name="edit_user">
          <input type="hidden" name="action" value="edt_user">
          <div class="modal-header">
            <h6 class="modal-title"><i class="fas fa-user-edit"></i> Edição de Usuário</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body p-0">
            <div id="info_edt_user" class="p-4 text-muted">
              Carregando informações do usuário...
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-info btn-sm" data-dismiss="modal">Fechar</button>
            <button type="submit" class="btn btn-outline-danger btn-sm">Salvar Alterações</button>
          </div>
        </form>
      </div>
    </div>
  ...
  <script>
    $(function() {
      ...
      $(document).on('click', '.view_data', function() {
        ...
        $("#info_edt_user").html('<div class="text-center p-5"><i class="fas fa-spinner fa-spin fa-2x"></i></div>');
