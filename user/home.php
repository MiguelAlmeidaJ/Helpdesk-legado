...
if ($usar_token=="true") {
  if($action){
    ...
    if ($action == "new_user") {
      ...
      $pdo = ConnectionN3();
      $adc_user= $pdo->prepare("INSERT INTO `usuarios` (`user_sts`, `user_nome`, `user_mail`, `user_cel`, `user_funcao`, `user_login`, `user_pass`) VALUES ('1', :user_nome, :user_mail, :user_cel, :user_funcao, :user_login, :user_pass);");
