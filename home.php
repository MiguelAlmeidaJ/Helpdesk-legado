...
<?php
$pdo = ConnectionN3();
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.tipo = '1' AND atendimentos.`status` IN (1,2,3,4,5)"); $show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_1 = $exibe["atd_num"]; if($atd_1==""){$atd_1=0;}

$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.tipo = '2' AND atendimentos.`status` IN (1,2,3,4,5)"); $show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_2 = $exibe["atd_num"]; if($atd_2==""){$atd_2=0;}

$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.tipo = '3' AND atendimentos.`status` IN (1,2,3,4,5)"); $show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_3 = $exibe["atd_num"]; if($atd_3==""){$atd_3=0;}

$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.tipo = '4' AND atendimentos.`status` IN (1,2,3,4,5)"); $show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_4 = $exibe["atd_num"]; if($atd_4==""){$atd_4=0;}

$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.tipo = '5' AND atendimentos.`status` IN (1,2,3,4,5)"); $show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
...
if(isset($positions[0]['atendimentos'])){ $p1_atd = ($positions[0]['atendimentos']); } else{$p1_atd = "";}
if(isset($positions[1]['atendimentos'])){ $p2_atd = ($positions[1]['atendimentos']); } else{$p2_atd = "";}
if(isset($positions[2]['atendimentos'])){ $p3_atd = ($positions[2]['atendimentos']); } else{$p3_atd = "";}
...
$pdo = ConnectionN3();
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_0a' AND '$dia_0' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_0 = $exibe["atd_num"]; if($atd_0==""){$atd_0=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_1a' AND '$dia_1' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_1 = $exibe["atd_num"]; if($atd_1==""){$atd_1=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_2a' AND '$dia_2' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_2 = $exibe["atd_num"]; if($atd_2==""){$atd_2=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_3a' AND '$dia_3' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_3 = $exibe["atd_num"]; if($atd_3==""){$atd_3=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_4a' AND '$dia_4' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_4 = $exibe["atd_num"]; if($atd_4==""){$atd_4=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_5a' AND '$dia_5' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_5 = $exibe["atd_num"]; if($atd_5==""){$atd_5=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_6a' AND '$dia_6' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_6 = $exibe["atd_num"]; if($atd_6==""){$atd_6=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_7a' AND '$dia_7' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
...
<?php 
$pdo = ConnectionN3();
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_0a' AND '$dia_0' AND atendimentos.`reincidente` = '1' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_0 = $exibe["atd_num"]; if($atd_0==""){$atd_0=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_1a' AND '$dia_1' AND atendimentos.`reincidente` = '1' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_1 = $exibe["atd_num"]; if($atd_1==""){$atd_1=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_2a' AND '$dia_2' AND atendimentos.`reincidente` = '1' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_2 = $exibe["atd_num"]; if($atd_2==""){$atd_2=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_3a' AND '$dia_3' AND atendimentos.`reincidente` = '1' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_3 = $exibe["atd_num"]; if($atd_3==""){$atd_3=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_4a' AND '$dia_4' AND atendimentos.`reincidente` = '1' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_4 = $exibe["atd_num"]; if($atd_4==""){$atd_4=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_5a' AND '$dia_5' AND atendimentos.`reincidente` = '1' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_5 = $exibe["atd_num"]; if($atd_5==""){$atd_5=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_6a' AND '$dia_6' AND atendimentos.`reincidente` = '1' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_6 = $exibe["atd_num"]; if($atd_6==""){$atd_6=0;}
$show = $pdo->prepare("SELECT count(atendimentos.id) AS atd_num FROM atendimentos WHERE atendimentos.abertura BETWEEN '$dia_7a' AND '$dia_7' AND atendimentos.`reincidente` = '1' AND atendimentos.`status` > '0' ");$show ->execute();$exibe=$show->fetch(PDO::FETCH_ASSOC);
$atd_7 = $exibe["atd_num"]; if($atd_7==""){$atd_7=0;}
