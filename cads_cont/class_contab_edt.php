...
if(isset($_POST["id"])){
  ...
  $pdo = ConnectionN3();
  $show = $pdo->prepare("SELECT cads_class_contab.* FROM cads_class_contab WHERE cads_class_contab.id = '$id'");
  $show->execute();
...
?>          
              <div class="form-group row my-1">
                <label class="col-4 col-form-label text-right">Classe Contabil:</label> 
                <div class="col-8">
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <div class="input-group-text"><i class="fas fa-funnel-dollar"></i></div>
                    </div> 
                    <input name="categoria" type="text" class="form-control" required="required" value="<?php echo $categoria; ?>">
