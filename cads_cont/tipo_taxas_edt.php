...
if(isset($_POST["id"])){
  ...
  $pdo = ConnectionN3();
  $show = $pdo->prepare("SELECT cads_tipo_taxa.* FROM cads_tipo_taxa WHERE cads_tipo_taxa.id = '$id'");
  $show->execute();
...
?>          
              ...
              <div class="form-group row my-1">
                <label class="col-4 col-form-label text-right">Tipo de Taxa:</label> 
                <div class="col-8">
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <div class="input-group-text"><i class="fas fa-tag"></i></div>
                    </div> 
                    <input name="taxa" type="text" class="form-control" required="required" value="<?php echo $tipo_servi; ?>">
