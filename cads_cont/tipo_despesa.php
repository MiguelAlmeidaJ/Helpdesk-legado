        ...
        <div class="col-md-12 mt-2">
          <div class="card">
            <div class="card-header py-2">
              <div class="row">
                <div class="col-6 h6 pt-1"><i class="fas fa-tag"></i> Tipo de Despesas Cadastrados </div>
...
<?php
$pdo = ConnectionN3();
$show_eqp = $pdo->prepare("SELECT cads_tipo_despe.*, cads_class_contab.categoria
FROM cads_tipo_despe 
LEFT JOIN cads_class_contab ON cads_tipo_despe.class_contab = cads_class_contab.id
ORDER BY cads_tipo_despe.despesa ASC");
$show_eqp->execute();
...
?>
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-outline-secondary btn-sm view_TipoDespesa" id="<?php echo $row['id']; ?>"> <i class="far fa-edit"></i> </button>
                      </td>
                    </tr>
<?php } ?>
                  </tbody>
    ...
    <div class="modal-content">
      <form action="#" method="POST">
        <div class="modal-header">
          <h6 class="modal-title"><i class="fas fa-tag"></i> Cadastro de Tipo de Despesa</h6>
              ...
              <div class="form-group row my-1">
                ...
                <div class="col-8">
                  <div class="input-group">
                    ...
                    <input name="despesa" placeholder="Nome do Tipo de Despesa" type="text" class="form-control" required="required">
                  </div>
                </div>
              </div>
...
<?php }?>
<!-- MODAL DE EDIÇÃO -->
<div class="modal fade" id="modalEdtTipoDespesa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
<?php // if($m2_01==3){?>      
      <form method="POST" action="#">
        <div class="modal-header">
          <h6 class="modal-title" id="modalEdtCltLabel"><i class="fas fa-tag"></i> Edição do Tipo de Despesa</h6>
        ...
        <div class="modal-body p-0">
          <div class="row">
            <div class="col-md-12">        
              <span id="info_edt_TipoDespesa"></span>
            </div>
          </div>
        </div>
        <div class="modal-footer">
...
<script>
  $(document).ready(function(){
    $(document).on('click','.view_TipoDespesa', function(){
      var id = $(this).attr("id");
      if(id !== ''){
        var dados = {
          id: id
        };
        $.post('tipo_despesa_edt.php', dados, function(retorna){
          //Carregar o conteúdo para o usuário
          $("#info_edt_TipoDespesa").html(retorna);
          $('#modalEdtTipoDespesa').modal('show'); 
        });
      }
    });
  });
