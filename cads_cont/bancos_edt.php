...
if(isset($_POST["id"])){
  ...
  $pdo = ConnectionN3();
  $show = $pdo->prepare("SELECT cads_bancos.* FROM cads_bancos WHERE cads_bancos.id = '$id'");
  $show->execute();
...
?>          
              <div class="form-group row my-1">
                <label class="col-4 col-form-label text-right">Bancos:</label> 
                <div class="col-8">
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <div class="input-group-text"><i class="fas fa-comments-dollar"></i></div>
                    </div> 
                    <input name="bancos" type="text" class="form-control" required="required" value="<?php echo $bancos; ?>">
