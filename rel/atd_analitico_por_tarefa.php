              ...
              <div class="card py-0 my-0">
                <div class="card-header my-0 bg-light py-0 h6" id="headingOne">
                  <button class="btn" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                      <i class="fas fa-chart-bar"></i>  Relatério de Tarefas por Cliente
                  </button>
                </div>
        ...
        <div class="col-md-12">
          <div class="card bg-default">
            <div class="card-header py-2 h6">
              ...
              Relatério Analítico de Tarefas Por Cliente
            </div>
<?php 
$pdo = ConnectionN3();
$filterEmpresas = "";
...
$query = "SELECT count(tarefas.id) as n FROM tarefas WHERE tarefas.cliente = '$f_clt' AND tarefas.abertura BETWEEN '$data_1' AND DATE_ADD('$data_2', INTERVAL 1 DAY)" . $filterEmpresas;
...
<?php } ?>
<?php } else { ?>
             <span align="center";>Não há informações para exibir com os filtros selecionados. </span>
<?php } ?>
            </div>
          </div>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p><strong>Relatério Analítico de Tarefas por cliente:</strong></p>
        <p>Este relatório exibe de forma analítica os tarefas para um determinado cliente em um determinado período de tempo.</p>
        <p>São considerados os tarefas com os seguintes status:</p>
        <ul class="list">
        ...
        <p>Não são considerados os tarefas com o status:</p>
        <ul class="list">
