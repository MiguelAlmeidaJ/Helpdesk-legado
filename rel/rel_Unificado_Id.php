...
<body class="rel-legacy-body">
                                        ...
                                        <div class="col-12">
                                            <form action="#" method="POST">
                                                <div class="form-row align-items-center">
                                                    ...
                                                    <div class=" col-form-label-sm no-print">
                                                        <label>ID:</label>
                                                        <input type="text" name="f_clt" id="f_clt" class="form-control  form-control-sm" placeholder="ID" tabindex="1">
                                                    </div>
                                                    <!-- <div class="col-auto col-form-label-sm">
                                                        <label>Cliente:</label>
                                                        <select name="f_clt" id="f_clt" class="form-control form-control-sm mb-2 mt-n2 selectpicker" data-live-search="true" tabindex="1">
                                                            <option></option>
                                                            <?php
                                                            $filterEmpresas = null;
                                                    ...
                                                    <div class="col-auto col-form-label-sm">
                                                        <label>Local:</label>
                                                        <select name="f_local" id="f_local" class="form-control form-control-sm selectpicker" data-live-search="true" tabindex="1">
                                                    ...
                                                    <div class=" col-form-label-sm">
                                                        <label>Nível:</label>
                                                        <select name="f_nivel" class="form-control  form-control-sm">
    ...
    <i class="fas fa-file-pdf"></i> Exportar PDF
        ...
        <div>
            <!-- buscar nome do cliente f_clt e período data_1 data_2 -->

            <?php
            $dataInicial = date('d/m/Y', strtotime($data_1));
            $dataFinal = date('d/m/Y', strtotime($data_2));
            $sql = "SELECT clientes.clt_nomef FROM clientes WHERE clientes.clt_id = $f_clt AND clientes.clt_sts = '1'";
            $pdo = ConnectionN3();
            $show_clt = $pdo->prepare($sql);
            $show_clt->execute();
            while ($exibe = $show_clt->fetch(PDO::FETCH_ASSOC)) {
            ...
            //se resultado da busca for 0 nao exibe nada e se for 1 exibe o nome do cliente
            if ($show_clt->rowCount() > 0) {
                echo "<h5 class='text-center font-weight-bold mt-1 mb-0 bg-dark text-white p-2'> $clt - Período: $dataInicial - $dataFinal</h5>";
            }
            ?>
        </div>
